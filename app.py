...
with tab1:
	...
	with col[0]:
		...
		st.image('https://www.verywellhealth.com/thmb/_rzmX-wxLWUTPur8HtzrjmRjWoc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/sleep-apnea-overview-3014774-v1-5c5dbe9a46e0fb00017dd118.png')
	with col[1]:
